...
/*
 * This is a modified version (derived from commit 8e99c31) of the
 * ISO8601DateFormatter by Peter Hosey.
 * https://github.com/boredzo/iso-8601-date-formatter
 *
 * The class name was modified, so this library can be distribued together
 * with the 'Api Json Code Generator' for easy installation and co-exist
 * with with any other installations (for example via Cocoapods) of this
 * library within the same project. Also it was upgraded to ARC, @property-
 * style and to the iOS SDK 8.
 *
 * Please note the ApiISO8601DateFormatter_LICENSE.txt file.
 * ~ Nikolas Mayr - author of the Api Json Code Generator
 */
...
@interface ApiISO8601DateFormatter: NSFormatter

@property (nonatomic) NSString *lastUsedFormatString;
@property (nonatomic) NSDateFormatter *unparsingFormatter;

@property (nonatomic) NSCalendar *parsingCalendar;
@property (nonatomic) NSCalendar *unparsingCalendar;

@property (nonatomic) NSTimeZone *defaultTimeZone;
 ...
 */
@property ApiISO8601DateFormat format;
/*!
